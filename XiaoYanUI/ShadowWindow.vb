Public Class ShadowWindow
    '初始的过程参数
    Public ShadowSize As Integer = 25                     '阴影大小
    Public ShadowDistance As Integer = 25             '阴影距离
    ...
    Private Sub ShadowWindow_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        MainUI.Show(Me)
        '程序启动时调用
        DrawShadow(MainUI, ShadowDistance, ShadowSize, ShadowAngle, ShadowColor, ShadowOpacity)
        '窗体添加鼠标穿透功能，不会影响用户的鼠标操作
        SetWindowLong(Me.Handle, -20, GetWindowLong(Me.Handle, -20) Or &H80000 Or &H20&)
    End Sub

    Public Sub DrawShadow(ByVal UIWindow As Form, ByVal ShadowDistance As Integer, ByVal ShadowSize As Integer,
